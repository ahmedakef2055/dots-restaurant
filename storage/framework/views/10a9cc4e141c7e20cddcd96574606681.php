<aside id="app-sidebar" class="app-sidebar">
    <div class="app-logo-bar" style="position:relative; display:flex; align-items:center; justify-content:center;">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Point 88"
             class="h-11 w-11 object-contain rounded-xl shrink-0"
             style="position:absolute; left:1rem; z-index:1;">
        <div id="sidebar-logo-name" class="sidebar-brand-text flex items-center justify-center w-full">
            <img src="<?php echo e(asset('images/Logo_Name.png')); ?>" alt="Point 88"
                 class="object-contain"
                 style="height:2.6rem; max-width:calc(var(--sidebar-w) - 6.5rem);">
        </div>
    </div>
...
<?php /**PATH /var/www/dots/resources/views/components/layouts/sidebar.blade.php ENDPATH**/ ?>