...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('ui.reports.shift_logs.profile.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('ui.reports.shift_logs.profile.title'))]); ?>
    <style>
        @media print {
            #app-sidebar,
            .glass-nav,
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 print-hidden">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold tracking-tight" style="color:var(--on-surface)"><?php echo e(__('ui.reports.shift_logs.profile.title')); ?></h1>
            <p class="text-sm mt-1" style="color:var(--on-surface-var)">
                <?php echo e(__('ui.reports.shift_logs.profile.subtitle')); ?>

                <span class="font-mono font-semibold" style="color:var(--primary)">#<?php echo e($shiftLog->id); ?></span>
            </p>
        </div>

        <div class="flex flex-wrap items-center gap-2">
            <a href="<?php echo e(route('reports.shift-logs')); ?>" class="glass-button-secondary rounded-xl py-2 px-4 text-sm font-medium inline-flex items-center gap-2">
                ...
                <span class="hidden sm:inline"><?php echo e(__('ui.reports.shift_logs.profile.back')); ?></span>
            </a>
            <a href="<?php echo e(route('reports.shift-logs.receipt', $shiftLog)); ?>" target="_blank" rel="noopener"
    ...
    <div class="glass-panel-elevated rounded-2xl overflow-hidden mb-6 print-card">
        <div class="px-5 py-4 border-b"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0">
                    <h2 class="text-base sm:text-lg font-bold truncate" style="color:var(--on-surface)"><?php echo e(__('ui.reports.shift_logs.profile.identity.title')); ?></h2>
        ...
        <div class="px-5 py-4">
            <div class="grid gap-4 grid-cols-2 lg:grid-cols-4">
                ...
                ?>
                <?php $__currentLoopData = $identityFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => ''.e($field['icon']).'','class' => 'text-[14px]','style' => 'color:var(--primary)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($field['icon']).'','class' => 'text-[14px]','style' => 'color:var(--primary)']); ?>
...
<?php endif; ?>
                        <p class="text-[11px] font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e($field['label']); ?></p>
                    </div>
                    <p class="text-sm font-semibold truncate" style="color:var(--on-surface)"><?php echo e($field['value']); ?></p>
                </div>
        ...
        <div class="glass-panel rounded-2xl p-4 print-card transition-all duration-200"
            ...
            <div class="flex items-center gap-2 mb-3">
                <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg shrink-0"
                      style="background-color:color-mix(in srgb,<?php echo e($kpi['color']); ?> 10%,transparent);color:<?php echo e($kpi['color']); ?>">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => ''.e($kpi['icon']).'','class' => 'text-[18px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($kpi['icon']).'','class' => 'text-[18px]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                ...
                <p class="text-[11px] sm:text-xs font-semibold leading-tight" style="color:var(--on-surface-var)"><?php echo e($kpi['label']); ?></p>
            </div>
            <p class="text-lg sm:text-xl font-bold font-mono" style="color:<?php echo e($kpi['color']); ?>">
                <?php if(($kpi['nullable'] ?? false) && $kpi['value'] === null): ?>
                    -
                <?php else: ?>
                    <?php echo e(\App\Support\CurrencyFormatter::format((float) $kpi['value'])); ?>
    ...
    <div class="glass-panel-elevated rounded-2xl overflow-hidden mb-6 print-card">
        <div class="px-5 py-4 border-b flex items-center gap-2"
            ...
            <h3 class="text-sm font-bold" style="color:var(--on-surface)"><?php echo e(__('ui.reports.shift_logs.profile.settlement_title')); ?></h3>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr style="background-color:color-mix(in srgb,var(--surface-highest) 30%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                        <th class="px-5 py-3 text-start text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.reports.shift_logs.profile.settlement_label')); ?></th>
                        <th class="px-5 py-3 text-start text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.reports.shift_logs.profile.settlement_value')); ?></th>
                    </tr>
                </thead>
                <tbody class="divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                    <?php $__currentLoopData = $settlementRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="transition-colors"
                        onmouseenter="this.style.backgroundColor='rgba(255,255,255,0.02)'"
                        onmouseleave="this.style.backgroundColor=''">
                        <td class="px-5 py-3 font-medium" style="color:var(--on-surface)"><?php echo e($row['label']); ?></td>
                        <td class="px-5 py-3 font-mono" style="color:var(--on-surface-var)">
                            <?php echo e($row['value'] !== null ? \App\Support\CurrencyFormatter::format((float) $row['value']) : '-'); ?>
    ...
    <div class="glass-panel-elevated rounded-2xl overflow-hidden print-card">
        <div class="px-5 py-4 border-b flex items-center gap-2"
            ...
            <h3 class="text-sm font-bold" style="color:var(--on-surface)"><?php echo e(__('ui.reports.shift_logs.profile.orders.title')); ?></h3>
        </div>
        ...
        <div class="px-5 py-4">
            <div class="grid gap-3 grid-cols-2 xl:grid-cols-4 mb-4">
                ...
                <?php $__currentLoopData = $orderKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl p-3"
                     style="background-color:color-mix(in srgb,var(--surface-highest) 25%,transparent);border:1px solid color-mix(in srgb,var(--primary) 5%,transparent)">
                    <div class="flex items-center gap-1.5 mb-1.5">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => ''.e($stat['icon']).'','class' => 'text-[14px]','style' => 'color:'.e($stat['color']).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($stat['icon']).'','class' => 'text-[14px]','style' => 'color:'.e($stat['color']).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                        <p class="text-[11px] font-semibold" style="color:var(--on-surface-var)"><?php echo e($stat['label']); ?></p>
                    </div>
                    <?php if($stat['value'] !== null): ?>
                    <p class="text-lg font-bold" style="color:var(--on-surface)"><?php echo e($stat['value']); ?></p>
                    <?php else: ?>
                    <div class="flex flex-wrap gap-x-3 gap-y-0.5 text-xs font-medium" style="color:var(--on-surface-var)">
                        <span><?php echo e(__('ui.reports.shift_logs.profile.orders.mix.dine_in')); ?>: <strong style="color:var(--on-surface)"><?php echo e(number_format($orderStats['dine_in_orders'])); ?></strong></span>
                        <span><?php echo e(__('ui.reports.shift_logs.profile.orders.mix.takeaway')); ?>: <strong style="color:var(--on-surface)"><?php echo e(number_format($orderStats['takeaway_orders'])); ?></strong></span>
                        <span><?php echo e(__('ui.reports.shift_logs.profile.orders.mix.delivery')); ?>: <strong style="color:var(--on-surface)"><?php echo e(number_format($orderStats['delivery_orders'])); ?></strong></span>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr style="background-color:color-mix(in srgb,var(--surface-highest) 30%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                        ...
                        <th class="px-5 py-3 text-start text-xs font-semibold uppercase tracking-wider whitespace-nowrap" style="color:var(--on-surface-var)"><?php echo e($h); ?></th>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
                </thead>
                <tbody class="divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                    ...
                    <tr class="transition-colors"
                        onmouseenter="this.style.backgroundColor='rgba(255,255,255,0.02)'"
                        onmouseleave="this.style.backgroundColor=''">
                        <td class="px-5 py-3 font-mono text-xs font-semibold" style="color:var(--primary)"><?php echo e($order->order_number); ?></td>
                        <td class="px-5 py-3 whitespace-nowrap" style="color:var(--on-surface-var)">
                            <?php $ot = strtolower($order->order_type ?? ''); ?>
                            <span class="inline-flex items-center gap-1 text-xs">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => ''.e($ot === 'dine_in' ? 'restaurant' : ($ot === 'takeaway' ? 'takeout_dining' : 'delivery_dining')).'','class' => 'text-[14px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($ot === 'dine_in' ? 'restaurant' : ($ot === 'takeaway' ? 'takeout_dining' : 'delivery_dining')).'','class' => 'text-[14px]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                        ...
                        <td class="px-5 py-3">
                            <?php $os = strtolower($order->status ?? ''); ?>
                            <?php if($os === 'paid'): ?>
                            ...
                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full" style="background-color:var(--tertiary)"></span><?php echo e(ucfirst($order->status)); ?>

                            </span>
                            <?php endif; ?>
                        </td>
                        <td class="px-5 py-3 font-mono text-xs" style="color:var(--on-surface-var)"><?php echo e(\App\Support\CurrencyFormatter::format((float) $order->subtotal)); ?></td>
                        <td class="px-5 py-3 font-mono text-xs" style="color:var(--error)"><?php echo e(\App\Support\CurrencyFormatter::format((float) $order->discount_amount)); ?></td>
                        <td class="px-5 py-3 font-mono text-xs font-semibold" style="color:var(--on-surface)"><?php echo e(\App\Support\CurrencyFormatter::format((float) $order->total)); ?></td>
                        <td class="px-5 py-3 text-xs whitespace-nowrap" style="color:var(--on-surface-var)"><?php echo e($order->created_at?->format('Y-m-d H:i') ?? '-'); ?></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="7" class="px-5 py-14 text-center">
                            ...
                            <p class="text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.reports.shift_logs.profile.orders.empty')); ?></p>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
...
<?php endif; ?>
<?php /**PATH /var/www/dots-main/resources/views/reports/shift-log-profile.blade.php ENDPATH**/ ?>