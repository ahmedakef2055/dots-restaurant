...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('ui.inventory.create.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('ui.inventory.create.title'))]); ?>
    <div class="pb-8">
        ...
        <div class="flex items-center gap-4 mb-8">
            <a href="<?php echo e(route('inventory.index')); ?>"
               class="glass-button-secondary rounded-lg py-2 px-4 text-sm font-medium flex items-center gap-2 shrink-0">
                ...
                <?php echo e(__('ui.inventory.back')); ?>

            </a>
            <div>
                <h1 class="text-3xl font-bold tracking-tight" style="color:var(--on-surface)">
                    <?php echo e(__('ui.inventory.create.card_title')); ?>

                </h1>
                <p class="text-sm mt-0.5" style="color:var(--on-surface-var)">
                    <?php echo e(__('ui.inventory.create.card_subtitle')); ?>
        ...
        <div class="glass-panel-elevated rounded-2xl overflow-hidden relative max-w-4xl mx-auto">
            ...
            <form method="POST" action="<?php echo e(route('inventory.store')); ?>" class="relative z-10">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.name')); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.supplier')); ?>
                            ...
                            <div class="relative">
                                <select name="supplier_id"
                                    ...
                                    <option value=""><?php echo e(__('ui.inventory.fields.select_supplier')); ?></option>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-1.5 text-xs" style="color:var(--error)"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.unit')); ?>
                            ...
                            <div class="relative">
                                <select name="unit_id" required
                                        class="w-full rounded-xl glass-input px-4 py-2.5 text-sm appearance-none [&>option]:bg-[var(--surface-lowest)] [&>option]:text-[var(--on-surface)]">
                                    <option value=""><?php echo e(__('ui.inventory.fields.select_unit')); ?></option>
                                    <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($unit->id); ?>" <?php if(old('unit_id') == $unit->id): echo 'selected'; endif; ?>><?php echo e($unit->name); ?> (<?php echo e(strtoupper($unit->code)); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-[1.25em] h-[1.25em] inline-flex items-center justify-center align-middle shrink-0 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[20px]" style="color:var(--on-surface-var)"><path d="M480-360 280-560h400L480-360Z"/></svg>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="px-6 md:px-8 py-6">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.default_warehouse')); ?>

                            </label>
                            <input value="<?php echo e($mainWarehouse?->name); ?><?php if($mainWarehouse?->code): ?> (<?php echo e(strtoupper($mainWarehouse->code)); ?>)<?php endif; ?>"
                                   disabled
                            ...
                            <p class="mt-1.5 text-[11px] opacity-70" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.create.main_warehouse_hint')); ?>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.cost_per_unit')); ?>
                            ...
                            <div class="relative">
                                ...
                                <input name="cost" type="number" step="0.0001" min="0"
                                       value="<?php echo e(old('cost', 0)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.opening_quantity')); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                <?php echo e(__('ui.inventory.fields.low_stock_threshold')); ?>

                                <span style="color:var(--error)">*</span>
                            </label>
                            <input name="threshold" type="number" step="0.001" min="0"
                                   value="<?php echo e(old('threshold', 0)); ?>" required
                                   class="w-full rounded-xl glass-input px-4 py-2.5 text-sm font-mono">
                    ...
                    <details class="group rounded-xl overflow-hidden border transition-all"
                        ...
                        <summary class="cursor-pointer list-none px-5 py-4 flex items-center justify-between text-sm font-semibold transition-colors [&::-webkit-details-marker]:hidden hover:bg-[var(--surface-lowest)]">
                            <div class="flex items-center gap-2" style="color:var(--on-surface)">
                                ...
                                <?php echo e(__('ui.inventory.simplified.additional_settings')); ?>
                        ...
                        <div class="border-t px-5 py-5 grid gap-5 md:grid-cols-2"
                            ...
                            <div>
                                <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                    <?php echo e(__('ui.inventory.fields.expiry_date')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                    <?php echo e(__('ui.inventory.fields.expiry_alert_days')); ?>

                                </label>
                                <input type="number" name="expiry_alert_days" min="1" max="180"
                                       value="<?php echo e(old('expiry_alert_days', 7)); ?>"
                                       class="w-full rounded-xl glass-input px-4 py-2.5 text-sm font-mono">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                                    <?php echo e(__('ui.inventory.fields.status')); ?>
                ...
                <div class="px-6 md:px-8 py-6 border-t flex items-center justify-end gap-3"
                    ...
                    <a href="<?php echo e(route('inventory.index')); ?>"
                       class="glass-button-secondary rounded-xl py-2.5 px-6 text-sm font-medium">
                        <?php echo e(__('ui.common.cancel') ?? 'Cancel'); ?>
                    ...
                    <button type="submit"
                        ...
                        <?php echo e(__('ui.inventory.create.submit')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/dots-main/resources/views/inventory/create.blade.php ENDPATH**/ ?>