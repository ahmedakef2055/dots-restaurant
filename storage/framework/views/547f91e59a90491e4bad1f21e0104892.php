<?php if (isset($component)) { $__componentOriginal16f24443843d0b5d3eecb4ba79059320 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16f24443843d0b5d3eecb4ba79059320 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.pos-shell','data' => ['title' => __('ui.pos.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('layouts.pos-shell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('ui.pos.title'))]); ?>
    <div
        x-data="posPage({ products: <?php echo \Illuminate\Support\Js::from($products)->toHtml() ?>, categories: <?php echo \Illuminate\Support\Js::from($categories)->toHtml() ?>, tables: <?php echo \Illuminate\Support\Js::from($tables)->toHtml() ?>, deliveryEmployees: <?php echo \Illuminate\Support\Js::from($deliveryEmployees)->toHtml() ?>, activeShift: <?php echo \Illuminate\Support\Js::from($activeShift)->toHtml() ?> }, { storeOrder: '<?php echo e(route('pos.orders.store')); ?>', startShift: '<?php echo e(route('pos.shifts.start')); ?>', endShift: '<?php echo e(route('pos.shifts.end')); ?>', tableOrderTemplate: '<?php echo e(route('pos.tables.order', ['restaurantTable' => '__TABLE__'])); ?>', transferTableTemplate: '<?php echo e(route('pos.orders.transfer-table', ['order' => '__ORDER__'])); ?>', invoiceTemplate: '<?php echo e(route('orders.invoice', ['order' => '__ORDER__'])); ?>', customerLookupTemplate: '<?php echo e(route('pos.customers.lookup', ['phone' => '__PHONE__'])); ?>', barcodeLookup: '<?php echo e(route('pos.barcode.lookup')); ?>', tablesStatus: '<?php echo e(route('pos.tables.status')); ?>', selectTableRequiredMessage: '<?php echo e(__('messages.errors.select_table_for_dine_in')); ?>', deliveryCustomerRequiredMessage: '<?php echo e(__('ui.pos.delivery_customer.required_message')); ?>', deliveryEmployeeRequiredMessage: '<?php echo e(__('ui.pos.delivery_customer.delivery_employee_required_message')); ?>', deliveryEmployeeUnavailableMessage: '<?php echo e(__('ui.pos.delivery_customer.no_delivery_employees')); ?>', barcodeNotFoundMessage: '<?php echo e(__('ui.pos.barcode.not_found')); ?>', csrf: '<?php echo e(csrf_token()); ?>' })"
        class="pos-canvas">

        
        <div x-cloak x-show="!activeShift && !showEndShiftDonePrompt" class="flex-1 flex items-center justify-center p-6 w-full h-full relative">
            <div class="pos-shift-locked-card relative w-full max-w-sm rounded-3xl p-8 shadow-2xl text-center flex flex-col items-center" style="background:var(--surface-lowest);border:1px solid color-mix(in srgb,var(--outline-var) 40%,transparent 60%)">
                ...
                <div class="relative z-10 flex flex-col items-center text-center">
                    ...
                    <h2 class="text-xl font-bold mb-1" style="color:var(--on-surface)"><?php echo e(__('ui.pos.shift.title')); ?></h2>
                    <p class="text-sm mb-6 max-w-xs" style="color:var(--on-surface-var)"><?php echo e(__('ui.pos.shift.locked_message')); ?></p>
                    ...
                    <template x-if="lastClosedShift">
                        <div class="w-full mb-5 rounded-xl p-3 text-left" style="background:color-mix(in srgb,var(--surface-container) 60%,transparent 40%);border:1px solid color-mix(in srgb,var(--outline-var) 30%,transparent 70%)">
                            <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:var(--outline)"><?php echo e(__('ui.pos.shift.last_closed_title')); ?></p>
                            <div class="flex justify-between text-xs" style="color:var(--on-surface-var)">
                                <span><?php echo e(__('ui.pos.shift.total_sales')); ?></span>
                            ...
                            <div class="flex justify-between text-xs mt-1" style="color:var(--on-surface-var)">
                                <span><?php echo e(__('ui.pos.shift.difference')); ?></span>
                    ...
                    <div class="w-full max-w-xs">
                        <label class="pos-label text-left block"><?php echo e(__('ui.pos.shift.opening_cash')); ?></label>
                        <input
                            x-model="openingCash"
                            type="number"
                            min="0"
                            step="0.01"
                            placeholder="<?php echo e(__('ui.pos.shift.opening_cash_placeholder')); ?>"
                        ...
                        <button
                            ...
                            <span x-show="!startingShift"><?php echo e(__('ui.pos.shift.start_button')); ?></span>
                            <span x-show="startingShift"><?php echo e(__('ui.pos.shift.starting_button')); ?></span>
                        </button>
        ...
        <div class="pos-mobile-tabs lg:hidden" x-show="!!activeShift">
            <button type="button"
                ...
                <span><?php echo e(__('ui.pos.filters.all_products')); ?></span>
            </button>
            <button type="button"
                @click="posTab = 'cart'"
                ...
                <span><?php echo e(__('ui.pos.cart.title')); ?></span>
        ...
        <section class="pos-left" x-show="!!activeShift && (posTab === 'products')" :class="{ 'pos-mobile-hidden': posTab !== 'products' }">
            ...
            <div class="px-3 pt-3 pb-1">
                <div class="relative">
                    ...
                    <input
                        type="text"
                        x-model="search"
                        placeholder="<?php echo e(__('ui.pos.search_products_placeholder')); ?>"
            ...
            <div class="pos-filter-wrap">
                ...
                <div class="pos-cat-type-tabs">
                    ...
                    <template x-if="categories.some(c => c.type === 'main')">
                        <button type="button"
                            ...
                            <span><?php echo e(__('ui.pos.filters.main_categories')); ?></span>
                        </button>
                    </template>
                    <template x-if="categories.some(c => c.type === 'sub')">
                        <button type="button"
                            ...
                            <span><?php echo e(__('ui.pos.filters.sub_categories')); ?></span>
                        </button>
                    </template>
                </div>
                ...
                <div class="pos-category-bar">
                    <button type="button"
                        ...
                        <?php echo e(__('ui.pos.filters.all')); ?>
                    ...
                    <template x-if="!visibleCategories.length">
                        <span class="pos-chip opacity-50"><?php echo e(__('ui.pos.filters.no_categories')); ?></span>
                    </template>
                </div>
            </div>
            ...
            <div class="px-3 pb-2 pt-1">
                <div class="flex items-center gap-2 rounded-xl px-3 py-2"
                    ...
                    <input
                        ...
                        autocomplete="off"
                        placeholder="<?php echo e(__('ui.pos.barcode.scan_placeholder')); ?>"
                    ...
                    <button type="button"
                        ...
                        <?php echo e(__('ui.pos.barcode.scan_button')); ?>
                ...
                <div class="pos-product-grid">
                    <template x-if="!filteredProducts.length">
                        <div class="pos-empty-state col-span-full">
                            ...
                            <p><?php echo e(__('ui.pos.no_products_for_filter')); ?></p>
                        </div>
                    </template>
        ...
        <aside class="pos-right" x-show="!!activeShift && (posTab === 'cart')" :class="{ 'pos-mobile-hidden': posTab !== 'cart' }">

            
            <div class="pos-ticket-header flex justify-between items-start">
                <div>
                    <h2 class="pos-ticket-title">
                        <?php echo e(__('ui.pos.cart.title')); ?>
                ...
                <button type="button" @click="requestEndShift()" class="h-8 px-3 rounded-lg flex items-center gap-1.5 transition-colors" style="background:color-mix(in srgb,var(--error) 10%,transparent 90%);color:var(--error)" title="<?php echo e(__('ui.pos.shift.end_confirm_title')); ?>">
                    ...
                    <span class="text-xs font-semibold"><?php echo e(__('ui.pos.shift.end_confirm_title')); ?></span>
                </button>
            </div>

            
            <div x-cloak x-show="orderType === 'dine_in'" class="pos-table-selector">
                <p class="pos-section-label"><?php echo e(__('ui.pos.select_table')); ?></p>
                    ...
                    <template x-for="table in tables" :key="table.id">
                        <button
                            ...
                            <span
                                ...
                                x-text="table.status === 'occupied' ? '<?php echo e(__('ui.common.occupied')); ?>' : (table.status === 'reserved' ? '<?php echo e(__('ui.common.reserved')); ?>' : '<?php echo e(__('ui.common.available')); ?>')"
                            </span>
                        </button>
                    </template>
                </div>
                ...
                <div x-cloak x-show="activeOrder" class="pos-active-order-banner">
                    <p class="font-semibold text-xs"><?php echo e(__('ui.pos.active_order.title')); ?></p>
                    <p class="text-xs mt-0.5">
                        <span class="font-medium"><?php echo e(__('ui.pos.active_order.number')); ?>:</span>
                        <span x-text="activeOrder ? activeOrder.order_number : ''"></span>
                    </p>
                    <p class="text-xs">
                        <span class="font-medium"><?php echo e(__('ui.pos.active_order.items')); ?>:</span>
                        <span x-text="activeOrder ? activeOrder.items_count : 0"></span>
                    </p>
                    <p class="text-xs">
                        <span class="font-medium"><?php echo e(__('ui.pos.active_order.total')); ?>:</span>
                ...
                <div x-cloak x-show="activeOrder" class="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center">
                    <select x-model="transferTableId" class="pos-select flex-1">
                        <option value=""><?php echo e(__('ui.pos.transfer.select_destination')); ?></option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'secondary','class' => 'shrink-0','@click' => 'transferOrderTable','xBind:disabled' => 'processing || !transferTableId','xBind:class' => '(processing || !transferTableId) ? \'opacity-60 cursor-not-allowed\' : \'\'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','class' => 'shrink-0','@click' => 'transferOrderTable','x-bind:disabled' => 'processing || !transferTableId','x-bind:class' => '(processing || !transferTableId) ? \'opacity-60 cursor-not-allowed\' : \'\'']); ?>
                        <?php echo e(__('ui.pos.transfer.button')); ?>
...
<?php endif; ?>
            ...
            <div class="pos-cart-scroll-area">
                ...
                <div class="pos-cart-items">
                    <template x-if="!cart.length">
                        <div class="pos-empty-state h-full">
                            ...
                            <p><?php echo e(__('ui.pos.cart.empty')); ?></p>
                        </div>
                    </template>
                    ...
                    <template x-for="item in cart" :key="item.cart_key">
                        <div class="pos-cart-item group" :data-cart-key="item.cart_key">
                            ...
                            <input
                                x-model="item.notes"
                                type="text"
                                placeholder="<?php echo e(__('ui.pos.item_notes_placeholder')); ?>"
                ...
                <div class="pos-ticket-footer">
                    ...
                    <div class="grid grid-cols-2 gap-2" x-cloak x-show="orderType !== 'dine_in'">
                        <div>
                            <label class="pos-label"><?php echo e(__('ui.pos.discount_type') ?? 'Discount Type'); ?></label>
                            <select x-model="discountType" @change="onDiscountTypeChange()" class="pos-select">
                                <option value="none"><?php echo e(__('ui.pos.no_discount') ?? 'None'); ?></option>
                                <option value="fixed"><?php echo e(__('ui.pos.fixed') ?? 'Fixed'); ?></option>
                                <option value="percentage"><?php echo e(__('ui.pos.percentage') ?? 'Percentage'); ?></option>
                            </select>
                        </div>
                        <div x-cloak x-show="discountType !== 'none'">
                            <label class="pos-label"><?php echo e(__('ui.pos.discount_value') ?? 'Value'); ?></label>
                    ...
                    <div x-cloak x-show="orderType !== 'dine_in' && discountType !== 'none'">
                        <label class="pos-label"><?php echo e(__('ui.pos.coupon_code') ?? 'Coupon'); ?></label>
                        <input x-model="couponCode" type="text" placeholder="<?php echo e(__('ui.pos.enter_coupon') ?? 'Enter coupon code'); ?>" class="pos-input uppercase">
                    </div>

                    <div>
                        <label class="pos-label"><?php echo e(__('ui.pos.notes') ?? 'Notes'); ?></label>
                    ...
                    <div x-cloak x-show="orderType !== 'dine_in'">
                        <label class="pos-label"><?php echo e(__('ui.pos.payment_method')); ?></label>
                        <div class="grid grid-cols-4 gap-1.5">
                            ...
                            ?>
                            <?php $__currentLoopData = $pmMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pmKey => $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" @click="paymentMethod = '<?php echo e($pmKey); ?>'"
                                :style="paymentMethod === '<?php echo e($pmKey); ?>'
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-4 h-4"><path d="<?php echo e($pm['svg']); ?>"/></svg>
                                <span><?php echo e($isAr ? $pm['label_ar'] : $pm['label_en']); ?></span>
                            </button>
                    ...
                    <button
                        ...
                        <span x-show="!processing"><?php echo e(__('ui.pos.send_to_kitchen') ?? 'Send to Kitchen'); ?></span>
                        <span x-show="processing"><?php echo e(__('ui.pos.processing') ?? 'Processing…'); ?></span>
                    </button>
                </div>
        ...
        <div
            ...
            <div
                ...
                <h3 class="pos-modal-title"><?php echo e(__('ui.pos.delivery_customer.title')); ?></h3>
                <p class="pos-modal-subtitle"><?php echo e(__('ui.pos.delivery_customer.subtitle')); ?></p>

                <div class="mt-4 grid gap-3 md:grid-cols-2">
                    <div class="md:col-span-2">
                        <label class="pos-label"><?php echo e(__('ui.pos.delivery_customer.delivery_employee')); ?></label>
                        <select x-model="deliveryCustomer.employee_id" class="pos-select">
                            <option value=""><?php echo e(__('ui.pos.delivery_customer.select_delivery_employee')); ?></option>
                    ...
                    <div class="relative md:col-span-2" @click.away="showDeliverySuggestions = false">
                        <label class="pos-label"><?php echo e(__('ui.pos.delivery_customer.phone')); ?></label>
                        <input
                            ...
                            class="pos-input"
                            placeholder="<?php echo e(__('ui.pos.delivery_customer.phone_placeholder')); ?>">
                    ...
                    <div>
                        <label class="pos-label"><?php echo e(__('ui.pos.delivery_customer.name')); ?></label>
                        <input x-model="deliveryCustomer.name" type="text" class="pos-input"
                            placeholder="<?php echo e(__('ui.pos.delivery_customer.name_placeholder')); ?>">
                    </div>

                    <div>
                        <label class="pos-label"><?php echo e(__('ui.pos.delivery_customer.address')); ?></label>
                        <input x-model="deliveryCustomer.address" type="text" class="pos-input"
                            placeholder="<?php echo e(__('ui.pos.delivery_customer.address_placeholder')); ?>">
                    </div>
                </div>
                ...
                <div class="pos-modal-actions">
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'secondary','@click' => 'closeDeliveryCustomerPrompt']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','@click' => 'closeDeliveryCustomerPrompt']); ?><?php echo e(__('ui.common.cancel')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','@click' => 'confirmDeliveryCustomer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','@click' => 'confirmDeliveryCustomer']); ?><?php echo e(__('ui.pos.delivery_customer.confirm')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
        ...
        <div
            ...
            <div
                ...
                <h3 class="pos-modal-title"><?php echo e(__('ui.pos.print_prompt.title')); ?></h3>
                <p class="pos-modal-subtitle"><?php echo e(__('ui.pos.print_prompt.message')); ?></p>
                ...
                <div class="pos-modal-actions">
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'secondary','@click' => 'closePrintPrompt']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','@click' => 'closePrintPrompt']); ?><?php echo e(__('ui.pos.print_prompt.no')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','@click' => 'printPromptInvoice']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','@click' => 'printPromptInvoice']); ?><?php echo e(__('ui.pos.print_prompt.yes')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
        ...
        <div x-cloak x-show="showEndShiftConfirmPrompt" class="pos-modal-backdrop">
            ...
            <div
                ...
                <h3 class="pos-modal-title"><?php echo e(__('ui.pos.shift.end_confirm_title')); ?></h3>
                <p class="pos-modal-subtitle"><?php echo e(__('ui.pos.shift.end_confirm_message')); ?></p>

                <div class="pos-modal-actions">
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'secondary','@click' => 'closeEndShiftConfirmPrompt()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','@click' => 'closeEndShiftConfirmPrompt()']); ?><?php echo e(__('ui.common.cancel')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','@click' => 'openEndShiftSettlementPrompt()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','@click' => 'openEndShiftSettlementPrompt()']); ?><?php echo e(__('ui.pos.shift.end_confirm_yes')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
        ...
        <div x-cloak x-show="showEndShiftSettlementPrompt" class="pos-modal-backdrop">
            ...
            <div
                ...
                <h3 class="pos-modal-title"><?php echo e(__('ui.pos.shift.settlement_title')); ?></h3>
                <p class="pos-modal-subtitle"><?php echo e(__('ui.pos.shift.settlement_subtitle')); ?></p>

                <div class="mt-5 space-y-4">
                    <div>
                        <label class="pos-label"><?php echo e(__('ui.pos.shift.actual_cash')); ?></label>
                        <div class="pos-input-wrap">
                            ...
                            <input x-model="actualCash" type="number" min="0" step="0.01"
                                   inputmode="decimal"
                                   class="pos-input pos-input-with-icon"
                                   placeholder="<?php echo e(__('ui.pos.shift.actual_cash_placeholder')); ?>">
                        </div>
                    </div>

                    <div>
                        <label class="pos-label"><?php echo e(__('ui.pos.shift.tips')); ?></label>
                        <div class="pos-input-wrap">
                            ...
                            <input x-model="shiftTips" type="number" min="0" step="0.01"
                                   inputmode="decimal"
                                   class="pos-input pos-input-with-icon"
                                   placeholder="<?php echo e(__('ui.pos.shift.tips_placeholder')); ?>">
                        </div>
                        <p class="mt-1 text-xs" style="color:var(--outline)"><?php echo e(__('ui.pos.shift.tips_note')); ?></p>
                    </div>
                ...
                <div class="pos-modal-actions">
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'secondary','@click' => 'closeEndShiftSettlementPrompt()','xBind:disabled' => 'endingShift']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','@click' => 'closeEndShiftSettlementPrompt()','x-bind:disabled' => 'endingShift']); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','@click' => 'endShift()','xBind:disabled' => 'endingShift','xBind:class' => 'endingShift ? \'opacity-60 cursor-not-allowed\' : \'\'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','@click' => 'endShift()','x-bind:disabled' => 'endingShift','x-bind:class' => 'endingShift ? \'opacity-60 cursor-not-allowed\' : \'\'']); ?>
                        <span x-show="!endingShift"><?php echo e(__('ui.pos.shift.end_submit_button')); ?></span>
                        <span x-show="endingShift"><?php echo e(__('ui.pos.shift.ending_button')); ?></span>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
...
<?php endif; ?>
        ...
        <div x-cloak x-show="showEndShiftDonePrompt" class="pos-modal-backdrop" style="z-index:110"
            ...
            <div
                ...
                <h3 class="pos-modal-title mt-2"><?php echo e(__('ui.pos.shift.end_done_title')); ?></h3>
                <p class="pos-modal-subtitle mb-6"><?php echo e(__('ui.pos.shift.end_done_message')); ?></p>
            </div>
        </div>
...
<script>
 ...
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16f24443843d0b5d3eecb4ba79059320)): ?>
<?php $attributes = $__attributesOriginal16f24443843d0b5d3eecb4ba79059320; ?>
<?php unset($__attributesOriginal16f24443843d0b5d3eecb4ba79059320); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal16f24443843d0b5d3eecb4ba79059320)): ?>
<?php $component = $__componentOriginal16f24443843d0b5d3eecb4ba79059320; ?>
<?php unset($__componentOriginal16f24443843d0b5d3eecb4ba79059320); ?>
<?php endif; ?><?php /**PATH /var/www/dots/resources/views/pos/index.blade.php ENDPATH**/ ?>