...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('ui.recipes.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('ui.recipes.title'))]); ?>


<?php if(! empty($showSemiFinishedCreateForm)): ?>
<?php
...
<div class="flex items-center gap-4 mb-6">
    <a href="<?php echo e(route('recipes.index')); ?>#semi"
       class="glass-button-secondary rounded-lg py-2 px-4 text-sm font-medium flex items-center gap-2 shrink-0">
        ...
        <?php echo e(__('ui.recipes.edit.back')); ?>

    </a>
    <div>
        <h1 class="text-3xl font-bold tracking-tight" style="color:var(--on-surface)"><?php echo e($formTitle); ?></h1>
        <p class="text-sm mt-0.5" style="color:var(--on-surface-var)"><?php echo e($formSubtitle); ?></p>
    </div>
</div>
...
<div class="glass-panel rounded-xl px-4 py-3 mb-5 flex items-center gap-2 border-s-4" style="border-inline-start-color:var(--tertiary)">
    ...
    <p class="text-sm" style="color:var(--on-surface-var)">
        <?php echo e(__('ui.recipes.warehouse_scope', ['warehouse' => $recipeWarehouseName ?? 'Branch Warehouse'])); ?>
...
<div class="glass-panel-elevated rounded-2xl overflow-hidden">
    <form method="POST" action="<?php echo e($semiFinishedFormAction ?? route('recipes.semi-finished.store')); ?>" class="space-y-0">
        <?php echo csrf_field(); ?>
        <?php if(! empty($semiFinishedFormMethod)): ?> <?php echo method_field($semiFinishedFormMethod); ?> <?php endif; ?>

        <input type="hidden" name="selling_price" value="<?php echo e(old('selling_price', $semiFinishedRecipe?->selling_price ?? 0)); ?>">
        ...
        <div class="px-6 pt-6 pb-5">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.fields.name')); ?></label>
                    <input name="name" value="<?php echo e(old('name', $semiFinishedRecipe?->name)); ?>" required
                           class="w-full rounded-xl glass-input px-3 py-2.5 text-sm">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.fields.yield_quantity')); ?></label>
                    <input name="yield_quantity" type="number" min="0.001" step="0.001"
                           value="<?php echo e(old('yield_quantity', $semiFinishedRecipe?->yield_quantity ?? 1)); ?>" required
                           class="w-full rounded-xl glass-input px-3 py-2.5 text-sm font-mono">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.fields.notes')); ?></label>
                    <input name="notes" value="<?php echo e(old('notes', $semiFinishedRecipe?->notes)); ?>"
                           class="w-full rounded-xl glass-input px-3 py-2.5 text-sm">
                </div>
            </div>
            <div class="grid gap-4 md:grid-cols-2 mt-4">
                <div>
                    <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.fields.waste_percent')); ?></label>
                    <input id="wasteInput" name="waste_percentage" type="number" min="0" max="100" step="0.01"
                           value="<?php echo e(old('waste_percentage', $semiFinishedRecipe?->waste_percentage ?? 0)); ?>"
                           class="w-full rounded-xl glass-input px-3 py-2.5 text-sm font-mono">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.fields.loss_percent')); ?></label>
                    <input id="lossInput" name="loss_percentage" type="number" min="0" max="100" step="0.01"
                           value="<?php echo e(old('loss_percentage', $semiFinishedRecipe?->loss_percentage ?? 0)); ?>"
                           class="w-full rounded-xl glass-input px-3 py-2.5 text-sm font-mono">
                </div>
            </div>
        </div>
        ...
        <div class="overflow-hidden">
            <div class="px-6 py-4 flex items-center justify-between" style="background-color:color-mix(in srgb,var(--surface-highest) 25%,transparent)">
                <h3 class="text-sm font-semibold flex items-center gap-2" style="color:var(--on-surface)">
                    ...
                    <?php echo e(__('ui.recipes.sections.raw_materials')); ?>
                ...
                <button type="button" id="addIngredientRow"
                    ...
                    <?php echo e(__('ui.recipes.actions.add_raw_material')); ?>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr style="background-color:color-mix(in srgb,var(--surface-highest) 40%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.ingredient')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.available_stock')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.unit')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.unit_cost')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.qty_required')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.line_total')); ?></th>
        ...
        <div class="overflow-hidden">
            <div class="px-6 py-4 flex items-center justify-between" style="background-color:color-mix(in srgb,var(--surface-highest) 25%,transparent)">
                <h3 class="text-sm font-semibold flex items-center gap-2" style="color:var(--on-surface)">
                    ...
                    <?php echo e(__('ui.recipes.sections.semi_finished_components')); ?>
                ...
                <button type="button" id="addComponentRow"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-[1.25em] h-[1.25em] inline-flex items-center justify-center align-middle shrink-0 text-[15px]" ><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
                    <?php echo e(__('ui.recipes.actions.add_semi_finished')); ?>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr style="background-color:color-mix(in srgb,var(--surface-highest) 40%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.component')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.yield')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.cost_per_unit')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.qty_required')); ?></th>
                            <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.line_total')); ?></th>
                            <th class="px-4 py-3"></th>
                        </tr>
        ...
        <div class="px-6 py-5" style="background-color:color-mix(in srgb,var(--surface-highest) 20%,transparent)">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="glass-panel rounded-xl p-4">
                    <p class="text-[10px] font-semibold uppercase tracking-wider mb-1" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.totals.ingredients_subtotal')); ?></p>
                    <p id="ingredientsSubtotal" class="text-base font-bold font-mono" style="color:var(--on-surface)">0.0000</p>
                </div>
                <div class="glass-panel rounded-xl p-4">
                    <p class="text-[10px] font-semibold uppercase tracking-wider mb-1" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.totals.components_subtotal')); ?></p>
                    <p id="componentsSubtotal" class="text-base font-bold font-mono" style="color:var(--on-surface)">0.0000</p>
                </div>
                <div class="glass-panel rounded-xl p-4">
                    <p class="text-[10px] font-semibold uppercase tracking-wider mb-1" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.totals.total_before_waste')); ?></p>
                ...
                <div class="rounded-xl p-4" style="background-color:color-mix(in srgb,var(--primary) 10%,transparent);border:1px solid color-mix(in srgb,var(--primary) 20%,transparent)">
                    <p class="text-[10px] font-semibold uppercase tracking-wider mb-1" style="color:var(--primary)"><?php echo e(__('ui.recipes.totals.final_total')); ?></p>
        ...
        <div class="px-6 py-5 flex items-center gap-3">
            <button type="submit" class="glass-button-primary rounded-xl py-2.5 px-6 text-sm font-semibold flex items-center gap-2">
                ...
                <?php echo e($isSemiFinishedEdit ? __('ui.recipes.actions.save_recipe') : __('ui.recipes.actions.save_semi_finished')); ?>

            </button>
            <a href="<?php echo e(route('recipes.index')); ?>#semi" class="glass-button-secondary rounded-xl py-2.5 px-5 text-sm font-medium">
                <?php echo e(__('ui.recipes.edit.cancel')); ?>
...
<script id="semiFinishedBuilderData" type="application/json"><?php echo json_encode($builderData, JSON_UNESCAPED_UNICODE); ?></script>
...
<div class="mb-6">
    <h1 class="text-3xl font-bold tracking-tight" style="color:var(--on-surface)"><?php echo e(__('ui.recipes.title')); ?></h1>
    <p class="text-sm mt-1" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.subtitle')); ?></p>
</div>
...
<div class="inline-flex items-center gap-1 p-1 rounded-xl mb-6 glass-panel">
    <button type="button" id="recipesTabTrigger"
        ...
        <span class="flex items-center gap-2">
            ...
            <?php echo e(__('ui.recipes.tabs.recipes')); ?>
    ...
    <button type="button" id="semiTabTrigger"
        ...
        <span class="flex items-center gap-2">
            ...
            <?php echo e(__('ui.recipes.tabs.semi_finished')); ?>
...
<section id="recipesTabPanel">
    <div class="glass-panel-elevated rounded-2xl overflow-hidden">
        ...
        <div class="px-6 py-4 border-b flex flex-wrap items-center justify-between gap-4"
            ...
            <div>
                <h2 class="text-base font-semibold" style="color:var(--on-surface)"><?php echo e(__('ui.recipes.product_section.title')); ?></h2>
                <p class="text-xs mt-0.5" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.product_section.subtitle')); ?></p>
            </div>
            <div class="flex items-center gap-3 flex-wrap">
                <div class="relative">
                    ...
                    <input id="recipesSearchInput" type="text"
                           placeholder="<?php echo e(__('ui.recipes.filters.recipes_search_placeholder')); ?>"
                           class="glass-input rounded-xl pl-9 pr-4 py-2 text-sm w-56">
                </div>
                <a href="<?php echo e(route('recipes.create')); ?>" class="glass-button-primary rounded-xl py-2 px-4 text-sm font-medium flex items-center gap-2">
                    ...
                    <?php echo e(__('ui.recipes.product_section.add_recipe_button')); ?>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr style="background-color:color-mix(in srgb,var(--surface-highest) 35%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.name')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.selling_price')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-right" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.actions')); ?></th>
                    </tr>
                </thead>
                <tbody class="text-sm divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                    ...
                    <tr data-recipe-row data-name="<?php echo e(strtolower($product->name)); ?>"
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium" style="color:var(--on-surface)"><?php echo e($product->name); ?></span>
                            </div>
                        </td>
                        <td class="px-5 py-3 font-mono" style="color:var(--on-surface-var)"><?php echo e(\App\Support\CurrencyFormatter::format($product->price)); ?></td>
                        <td class="px-5 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('recipes.edit', ['product' => $product])); ?>"
                                   class="glass-button-secondary rounded-lg px-3 py-1.5 text-xs font-medium">
                                    <?php echo e(__('ui.common.edit')); ?>

                                </a>
                                <form method="POST" action="<?php echo e(route('recipes.destroy', $product)); ?>" class="inline-block">
                    ...
                    <tr>
                        <td colspan="3" class="px-5 py-10 text-center text-sm" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.no_products')); ?></td>
                    </tr>
                    <?php endif; ?>

                    <tr id="recipesFilterNoResults" class="hidden">
                        <td colspan="3" class="px-5 py-8 text-center text-sm" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.filters.no_recipe_matches')); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<section id="semiTabPanel" class="hidden">
    <div class="glass-panel-elevated rounded-2xl overflow-hidden">
        ...
        <div class="px-6 py-4 border-b flex flex-wrap items-center justify-between gap-4"
             style="border-color:color-mix(in srgb,var(--primary) 10%,transparent);background-color:color-mix(in srgb,var(--surface-highest) 20%,transparent)">
            <div>
                <h2 class="text-base font-semibold" style="color:var(--on-surface)"><?php echo e(__('ui.recipes.semi_finished.table_title')); ?></h2>
                <p class="text-xs mt-0.5" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.semi_finished.table_subtitle')); ?></p>
            </div>
            <div class="flex items-center gap-3 flex-wrap">
                <div class="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-[1.25em] h-[1.25em] inline-flex items-center justify-center align-middle shrink-0 absolute left-3 top-1/2 -translate-y-1/2 text-[18px]" style="color:var(--on-surface-var)"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
                    <input id="semiSearchInput" type="text"
                           placeholder="<?php echo e(__('ui.recipes.filters.semi_search_placeholder')); ?>"
                           class="glass-input rounded-xl pl-9 pr-4 py-2 text-sm w-56">
                </div>
                <a href="<?php echo e(route('recipes.semi-finished.create')); ?>" class="glass-button-primary rounded-xl py-2 px-4 text-sm font-medium flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-[1.25em] h-[1.25em] inline-flex items-center justify-center align-middle shrink-0 text-[18px]" ><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
                    <?php echo e(__('ui.recipes.semi_finished.add_button')); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr style="background-color:color-mix(in srgb,var(--surface-highest) 35%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.name')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.yield')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.cost_per_unit')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.cost')); ?></th>
                        <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-right" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.table.actions')); ?></th>
                    </tr>
                </thead>
                <tbody class="text-sm divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                    <?php $__empty_1 = true; $__currentLoopData = $semiFinishedRecipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    $yield       = max((float) $recipe->yield_quantity, 0.001);
                    $costPerUnit = (float) $recipe->total_cost / $yield;
                    ?>
                    <tr data-semi-row data-name="<?php echo e(strtolower($recipe->name)); ?>"
                        class="transition-colors"
                        onmouseenter="this.style.backgroundColor='rgba(255,255,255,0.02)'"
                        onmouseleave="this.style.backgroundColor=''">
                        <td class="px-5 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium" style="color:var(--on-surface)"><?php echo e($recipe->name); ?></span>
                            </div>
                        </td>
                        <td class="px-5 py-3 font-mono" style="color:var(--on-surface-var)"><?php echo e(number_format((float) $recipe->yield_quantity, 3)); ?></td>
                        <td class="px-5 py-3 font-mono" style="color:var(--on-surface-var)"><?php echo e(number_format($costPerUnit, 4)); ?></td>
                        <td class="px-5 py-3 font-mono font-semibold" style="color:var(--on-surface)"><?php echo e(number_format((float) $recipe->total_cost, 4)); ?></td>
                        <td class="px-5 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('recipes.semi-finished.edit', $recipe)); ?>"
                                   class="glass-button-secondary rounded-lg px-3 py-1.5 text-xs font-medium">
                                    <?php echo e(__('ui.common.edit')); ?>

                                </a>
                                <form method="POST" action="<?php echo e(route('recipes.semi-finished.destroy', $recipe)); ?>" class="inline-block">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit"
                                            class="rounded-lg px-3 py-1.5 text-xs font-medium transition-all"
                                            style="border:1px solid color-mix(in srgb,var(--error) 25%,transparent);color:var(--error)"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="5" class="px-5 py-10 text-center text-sm" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.semi_finished.none')); ?></td>
                    </tr>
                    <?php endif; ?>

                    <tr id="semiFilterNoResults" class="hidden">
                        <td colspan="5" class="px-5 py-8 text-center text-sm" style="color:var(--on-surface-var)"><?php echo e(__('ui.recipes.filters.no_semi_matches')); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/dots-main/resources/views/recipes/index.blade.php ENDPATH**/ ?>