...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Employees']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Employees']); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <a href="<?php echo e(route('attendance.index')); ?>" class="glass-button-secondary rounded-xl py-2 px-3 sm:px-4 text-sm font-medium flex items-center gap-2" title="Attendance">
            ...
            <a href="<?php echo e(route('salaries.index')); ?>" class="glass-button-secondary rounded-xl py-2 px-3 sm:px-4 text-sm font-medium flex items-center gap-2" title="Salaries">
            ...
            <a href="<?php echo e(route('employees.export.pdf', request()->query())); ?>" target="_blank" class="glass-button-secondary rounded-xl py-2 px-3 sm:px-4 text-sm font-medium flex items-center gap-2" title="Export PDF">
            ...
            <a href="<?php echo e(route('employees.create')); ?>" class="glass-button-primary rounded-xl py-2 px-3 sm:px-4 text-sm font-medium flex items-center gap-2">
    ...
    <form method="GET" action="<?php echo e(route('employees.index')); ?>"
        ...
        <div class="relative flex-1 min-w-56">
            ...
            <input name="q" value="<?php echo e($filters['q']); ?>" placeholder="Search name/phone/national ID"
        ...
        <div class="relative">
            <select name="status" class="glass-input rounded-xl px-4 py-2 text-sm appearance-none pr-8 [&>option]:bg-[var(--surface-lowest)] [&>option]:text-[var(--on-surface)] min-w-36">
                ...
                <option value="terminated" <?php if($filters['status']==='terminated'): echo 'selected'; endif; ?>>Terminated</option>
            </select>
        ...
        <a href="<?php echo e(route('employees.index')); ?>" class="glass-button-secondary rounded-xl py-2 px-4 text-sm font-medium">Reset</a>
    </form>
    ...
    <div class="glass-panel-elevated rounded-2xl overflow-hidden">
        <div class="px-5 py-4 border-b" style="border-color:color-mix(in srgb,var(--primary) 8%,transparent);background-color:color-mix(in srgb,var(--surface-highest) 20%,transparent)">
            <p class="text-sm" style="color:var(--on-surface-var)"><?php echo e($employees->total()); ?> employees total</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr style="background-color:color-mix(in srgb,var(--surface-highest) 30%,transparent);border-bottom:1px solid color-mix(in srgb,var(--primary) 8%,transparent)">
                        <?php $__currentLoopData = ['Name','National ID','Phone','Position','Salary','Status','Records','Actions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tbody class="text-sm divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                    ...
                    <tr class="transition-colors"
                        ...
                        <td class="px-5 py-3 font-medium" style="color:var(--on-surface)"><?php echo e($employee->full_name); ?></td>
                        <td class="px-5 py-3 font-mono text-xs" style="color:var(--on-surface-var)"><?php echo e($employee->national_id_display ?: '-'); ?></td>
                        <td class="px-5 py-3" style="color:var(--on-surface-var)"><?php echo e($employee->phone ?: '-'); ?></td>
                        <td class="px-5 py-3" style="color:var(--on-surface-var)"><?php echo e($employee->position); ?></td>
                        <td class="px-5 py-3">
                            <div class="font-mono text-sm" style="color:var(--on-surface)"><?php echo e(\App\Support\CurrencyFormatter::format($employee->base_salary)); ?></div>
                            <div class="text-xs font-mono" style="color:var(--on-surface-var)">Daily: <?php echo e(\App\Support\CurrencyFormatter::format($employee->daily_salary)); ?></div>
                        </td>
                        <td class="px-5 py-3">
                        ...
                        <td class="px-5 py-3 text-xs" style="color:var(--on-surface-var)">
                            A: <?php echo e($employee->attendances_count); ?><br>S: <?php echo e($employee->salary_payments_count); ?>

                        </td>
                        <td class="px-5 py-3">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('employees.show', $employee)); ?>" class="glass-button-secondary rounded-lg px-3 py-1.5 text-xs font-medium">View</a>
                                <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="glass-button-secondary rounded-lg px-3 py-1.5 text-xs font-medium">Edit</a>
                                <form method="POST" action="<?php echo e(route('employees.destroy', $employee)); ?>" class="inline-block">
        ...
        <div class="px-5 py-4 border-t" style="border-color:color-mix(in srgb,var(--primary) 8%,transparent)"><?php echo e($employees->withQueryString()->links()); ?></div>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/dots-main/resources/views/employees/index.blade.php ENDPATH**/ ?>