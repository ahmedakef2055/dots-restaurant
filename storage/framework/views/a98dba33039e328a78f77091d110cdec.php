...
<head>
    ...
    <title><?php echo e(__('messages.auth.login.page_title')); ?></title>
    ...
    <div class="relative min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="absolute inset-e-4 top-4 z-20 flex items-center gap-2 sm:inset-e-6">
            <button data-language-toggle type="button" class="top-lang-btn"
                aria-label="<?php echo e(__('messages.auth.login.switch_language')); ?>"
                title="<?php echo e(__('messages.auth.login.switch_language')); ?>">
                <?php echo e(app()->getLocale() === 'ar' ? 'EN' : 'AR'); ?>

            </button>
            <button data-theme-toggle type="button" class="top-lang-btn min-w-28">
                <?php echo e(__('messages.auth.login.toggle_theme')); ?>
        ...
        <div class="relative z-10 w-full max-w-sm">
            <div class="rounded-3xl border border-[var(--outline-var)] bg-[var(--surface-lowest)] p-8 shadow-2xl backdrop-blur-md dark:border-[var(--outline-var)] dark:bg-[var(--surface-lowest)]">
                ...
                <div class="mb-8 flex flex-col items-center">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Dots" class="h-24 w-24 object-contain rounded-2xl shadow-lg">
                </div>
                ...
                <form method="POST" action="<?php echo e(route('login.attempt')); ?>" class="mt-7 space-y-4">
                    <?php echo csrf_field(); ?>

                    <div>
                        <label for="username" class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                            <?php echo e(__('messages.auth.login.username')); ?>

                        </label>
                        <input id="username" name="username" type="text" required autofocus
                            value="<?php echo e(old('username')); ?>" dir="ltr"
                    ...
                    <div>
                        <label for="password" class="mb-1.5 block text-sm font-medium" style="color:var(--on-surface-var)">
                            <?php echo e(__('messages.auth.login.password')); ?>
                    ...
                    <label class="inline-flex items-center gap-2 text-sm" style="color:var(--on-surface-var)">
                        ...
                        <span><?php echo e(__('messages.auth.login.remember_me')); ?></span>
                    </label>
                    ...
                    <button type="submit"
                        ...
                        <?php echo e(__('messages.auth.login.submit')); ?>
...
<?php /**PATH /var/www/dots-main/resources/views/auth/login.blade.php ENDPATH**/ ?>