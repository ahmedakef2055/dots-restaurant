...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('ui.orders.col.number', ['default' => 'Order #']) . ($order->order_daily_number ?: $order->order_number)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('ui.orders.col.number', ['default' => 'Order #']) . ($order->order_daily_number ?: $order->order_number))]); ?>
<div
    x-data="{
        ...
        deleteAction: '',
        deleteOrderNumber: '',
        discountType: '<?php echo e(old('discount_type', $order->discount_type ?: 'none')); ?>',
        loading: false,
...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('orders.index')); ?>"
           ...
           style="border-color:color-mix(in srgb,var(--outline-var) 50%,transparent);background:var(--surface-lowest);color:var(--on-surface-var)">
            ...
            <?php echo e(__('ui.common.back', ['default' => 'Back'])); ?>
        ...
        <div>
            ...
            <p class="text-xs mt-0.5 font-mono" style="color:var(--outline)">
                <?php echo e($order->order_number); ?> · <?php echo e($order->created_at->format('M d, Y · H:i')); ?>
    ...
    <div class="flex items-center gap-2">
        ...
        <button
            type="button"
            onclick="queuePrintJob(<?php echo e($order->order_serial); ?>, this)"
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
                    ...
                    <tr class="border-t group transition-all duration-150"
                        ...
                        <td class="px-4 py-3.5 text-center">
                            ...
                            <div class="inline-flex items-center gap-1">
                                <button type="button"
                                        ...
                                        data-url="<?php echo e(route('orders.items.quantity.update', [$order, $item])); ?>"
                                ...
                                <span class="qty-val w-8 text-center font-bold text-sm" style="color:var(--on-surface)"><?php echo e($item->quantity); ?></span>
                                <button type="button"
                            ...
                            <?php else: ?>
                            <span class="font-bold text-sm" style="color:var(--on-surface)"><?php echo e($item->quantity); ?></span>
                            <?php endif; ?>
                        </td>

                        <td class="px-4 py-3.5 text-sm" style="color:var(--on-surface-var)">
                            <?php echo e(\App\Support\CurrencyFormatter::format($item->unit_price)); ?>

                        </td>

                        <td class="px-4 py-3.5 text-right font-bold text-sm" style="color:var(--on-surface)">
                            <span class="line-total-val"><?php echo e(\App\Support\CurrencyFormatter::format($item->subtotal)); ?></span>
                        </td>
                        ...
                        <td class="px-4 py-3.5 text-center">
                            <button type="button"
                                    ...
                                    data-url="<?php echo e(route('orders.items.destroy', [$order, $item])); ?>"
            ...
            <div class="flex flex-col items-end gap-2 text-sm">
                <div class="flex justify-between w-56">
                    ...
                    <span class="font-semibold" style="color:var(--on-surface)" id="subtotal-val">
                        <?php echo e(\App\Support\CurrencyFormatter::format($order->subtotal)); ?>
                ...
                <div class="flex justify-between w-56">
                    ...
                    <span class="font-semibold text-[var(--success)]">
                        -<?php echo e(\App\Support\CurrencyFormatter::format($order->discount_amount)); ?>
    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="rounded-2xl border shadow-sm overflow-hidden"
            ...
            <div class="px-5 py-4 flex flex-col gap-3 text-sm">
                ...
                <div class="flex justify-between items-center gap-2">
                    <span style="color:var(--outline)"><?php echo e(__('ui.orders.col.number', ['default' => 'Order #'])); ?></span>
                    <span class="font-bold text-right" style="color:var(--primary)">#<?php echo e($order->order_daily_number); ?></span>
                </div>
                <?php endif; ?>
                <div class="flex justify-between items-center gap-2">
                    <span style="color:var(--outline)"><?php echo e(__('ui.orders.detail.serial', ['default' => 'Order Serial'])); ?></span>
                    <span class="font-bold text-right font-mono text-xs" style="color:var(--on-surface)"><?php echo e($order->order_number); ?></span>
                </div>
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $cls]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between items-center gap-2">
                    <span style="color:var(--outline)"><?php echo e($label); ?></span>
                    <span class="font-bold text-right <?php echo e($cls); ?>" style="color:var(--on-surface)"><?php echo e($value); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="rounded-2xl border shadow-sm overflow-hidden"
            ...
            <div class="px-5 py-4">
                <form action="<?php echo e(route('orders.discount.update', $order)); ?>" method="POST" class="flex flex-col gap-3">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="coupon_code" value="<?php echo e(old('coupon_code', $order->coupon_code)); ?>"
        ...
        <div class="rounded-2xl border shadow-sm overflow-hidden"
            ...
            <div class="px-5 py-4">
                <form action="<?php echo e(route('orders.status.update', $order)); ?>" method="POST" class="flex flex-col gap-3" x-data="{ updateStatusVal: '<?php echo e($order->status); ?>', paymentMethod: 'cash' }">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<?php endif; ?><?php /**PATH /var/www/dots-main/resources/views/orders/show.blade.php ENDPATH**/ ?>