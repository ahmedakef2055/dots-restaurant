<x-layouts.pos-shell :title="__('ui.pos.title')">
    <div
                    ...
                    <template x-if="lastClosedShift">
                        <div class="w-full mb-5 rounded-xl p-3 text-left" style="background:color-mix(in srgb,var(--surface-container) 60%,transparent 40%);border:1px solid color-mix(in srgb,var(--outline-var) 30%,transparent 70%)">
                            ...
                            <div class="flex justify-between text-xs mt-1" style="color:var(--on-surface-var)">
                                ...
                                <span x-text="currency(lastClosedShift.difference ?? 0)" :style="(lastClosedShift.difference ?? 0) >= 0 ? 'color:#4ade80' : 'color:var(--error)'"></span>
                            </div>
                        </div>
                    </template>
        ...
        ══════════════════════════════════════════════════════════ --}}
        <section class="pos-left" x-show="!!activeShift">
        ...
        ══════════════════════════════════════════════════════════ --}}
        <aside class="pos-right" x-show="!!activeShift">
            ...
            <div class="pos-cart-scroll-area">
                ...
                <div class="pos-ticket-footer">
                    ...
                    <p x-cloak x-show="success" class="text-xs font-medium text-emerald-500" x-text="success"></p>
        ...
        <div x-cloak x-show="showEndShiftDonePrompt" class="pos-modal-backdrop" style="z-index:110">
            ...
            <div
                ...
                <div class="pos-modal-success-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-[1.25em] h-[1.25em] inline-flex items-center justify-center align-middle shrink-0 text-4xl" style="font-variation-settings:'FILL' 1;color:#4ade80"><path d="m424-296 282-282-56-56-226 226-114-114-56 56 170 170Zm56 216q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                </div>
                ...
                <x-ui.button type="button" @click="finalizeEndShiftFlow()" class="w-full justify-center">
                    {{ __('ui.pos.shift.end_done_button') }}
                </x-ui.button>
            </div>
        </div>
