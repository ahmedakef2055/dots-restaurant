<x-layouts.app :title="__('ui.suppliers.title', [], 'Suppliers')">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
    ...
    <div class="glass-panel rounded-2xl p-6 relative overflow-hidden group transition-shadow duration-500"
        ...
        <div class="relative z-10">
            ...
            <div class="flex items-baseline gap-3">
                <span class="text-4xl font-bold tracking-tight" style="color:var(--on-surface)">{{ $totalSuppliers }}</span>
    ...
    <div class="glass-panel rounded-2xl p-6 relative overflow-hidden group transition-shadow duration-500"
        ...
        <div class="relative z-10">
            ...
            <div class="flex items-baseline gap-3">
                <span class="text-4xl font-bold tracking-tight" style="color:var(--on-surface)">{{ $activeCount }}</span>
    ...
    <div class="glass-panel rounded-2xl p-6 relative overflow-hidden group transition-shadow duration-500"
        ...
        <div class="relative z-10">
            ...
            <div class="flex items-baseline gap-3">
                <span class="text-4xl font-bold tracking-tight" style="color:var(--on-surface)">{{ $totalPurchases }}</span>
...
<div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-5">
    ...
    {{-- Search form --}}
    <form method="GET" action="{{ route('suppliers.index') }}" class="flex items-center gap-3 w-full sm:w-auto">
    ...
    <div class="flex items-center gap-2 w-full sm:w-auto">
        <a href="{{ route('suppliers.pdf', request()->query()) }}" target="_blank"
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y" style="border-color:color-mix(in srgb,var(--primary) 5%,transparent)">
                ...
                <tr class="transition-colors group"
                    ...
                    style="{{ !$supplier->is_active ? 'opacity:0.75' : '' }}">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs mt-0.5" style="color:var(--on-surface-var)">ID #{{ $supplier->id }}</div>
                            </div>
                        </div>
                    </td>
                    ...
                    {{-- Contact --}}
                    <td class="py-4 px-6 whitespace-nowrap">
                        <div class="text-sm" style="color:var(--on-surface)">{{ $supplier->contact_person ?: '-' }}</div>
                    ...
                    <td class="py-4 px-6 whitespace-nowrap text-center">
                        <div class="flex items-center justify-center gap-1.5">
                            ...
                            <form method="POST" action="{{ route('suppliers.destroy', $supplier) }}" class="inline-block">
                                @csrf @method('DELETE')
                                <button type="submit"
                                        class="p-1.5 rounded-lg border border-transparent transition-colors"
                                        style="color:var(--on-surface-var)"
                ...
                <tr>
                    <td colspan="6" class="py-12 text-center text-sm" style="color:var(--on-surface-var)">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <span>No suppliers found{{ $filters['q'] ? ' for "' . $filters['q'] . '"' : '.' }}</span>
                        </div>
                    </td>
                </tr>
                @endforelse
