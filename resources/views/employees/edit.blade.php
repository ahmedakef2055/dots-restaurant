<x-layouts.app title="Edit Employee">
    <div class="flex items-center gap-4 mb-8">
        <a href="{{ route('employees.show', $employee) }}" class="glass-button-secondary rounded-xl py-2 px-4 text-sm font-medium flex items-center gap-2 shrink-0">
        ...
        <div class="min-w-0">
            <h1 class="text-3xl font-bold tracking-tight truncate" style="color:var(--on-surface)">Edit Employee</h1>
            <p class="text-sm mt-0.5" style="color:var(--on-surface-var)">{{ $employee->full_name }}</p>
        </div>
    </div>
