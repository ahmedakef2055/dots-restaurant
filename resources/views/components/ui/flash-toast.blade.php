...
<div @class([ 'pointer-events-none fixed top-4 z-[70] flex w-[calc(100%-2rem)] max-w-sm flex-col gap-2' , 'left-4 sm:left-6'=> app()->getLocale() === 'ar',
    ...
    <div
        ...
        <div class="min-w-0">
            <p class="font-semibold" style="color:var(--primary)">{{ __('ui.toast.success') }}</p>
            <p style="color:var(--on-surface-var)">{{ $successMessage }}</p>
        </div>
    </div>
    @endif
    ...
    <div
        ...
        <div class="min-w-0">
            <p class="font-semibold" style="color:var(--error)">{{ __('ui.toast.error') }}</p>
            <p style="color:var(--on-surface-var)">{{ $errorMessage }}</p>
        </div>
    </div>
    @endif
</div>
