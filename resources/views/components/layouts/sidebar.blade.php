<aside id="app-sidebar" class="app-sidebar">
    <div class="app-logo-bar" style="display:flex; align-items:center; justify-content:center;">
        <img src="{{ asset('images/logo.png') }}" alt="Dots"
    ...
    <nav class="flex-1 space-y-5 px-3 py-2 text-sm overflow-y-auto">
        ...
        <div>
            <p class="sidebar-group-label">{{ __('ui.navigation.operations') }}</p>
            <div class="sidebar-menu">
                ...
                <a href="{{ route('dashboard') }}" @class(['sidebar-link', 'active'=> request()->routeIs('dashboard')])>
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.dashboard') }}</span>
                </a>
                @endif

                @if ($canPos)
                <a href="{{ route('pos.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('pos.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.pos') }}</span>
                </a>
                @endif

                @if ($canWaiter)
                <a href="{{ route('waiter.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('waiter.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.waiter') }}</span>
                </a>
                @endif

                @if ($canKds)
                <a href="{{ route('kds.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('kds.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.kds') }}</span>
                </a>
                @endif

                @if ($canBar)
                <a href="{{ route('bar.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('bar.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.bar') }}</span>
                </a>
                @endif

                @if ($canOrdersView)
                <a href="{{ route('orders.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('orders.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.orders') }}</span>
                </a>
                @endif
            </div>
        </div>
        ...
        <div>
            <p class="sidebar-group-label">{{ __('ui.navigation.management') }}</p>
            <div class="sidebar-menu">
                @if ($canInventory)
                <a href="{{ route('inventory.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('inventory.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.inventory') }}</span>
                </a>
                @endif

                @if ($canRecipes)
                <a href="{{ route('recipes.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('recipes.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.recipes') }}</span>
                </a>
                @endif

                @if ($canSuppliers)
                <a href="{{ route('suppliers.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('suppliers.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.suppliers') }}</span>
                </a>
                @endif

                @if ($canPurchases)
                <a href="{{ route('purchases.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('purchases.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.purchases') }}</span>
                </a>
                @endif

                @if ($canTables)
                <a href="{{ route('tables.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('tables.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.tables') }}</span>
                </a>
                @endif

                @if ($canCategories)
                <a href="{{ route('categories.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('categories.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.categories') }}</span>
                </a>
                @endif
                ...
                <a href="{{ route('products.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('products.*')])>
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.products') }}</span>
                </a>
                @endif

                @if ($canCustomers)
                <a href="{{ route('customers.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('customers.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.customers') }}</span>
                </a>
                @endif
            </div>
        </div>
        ...
        @if ($showAdminGroup)
        <div>
            <p class="sidebar-group-label">{{ __('ui.navigation.admin') }}</p>
            <div class="sidebar-menu">
                @if ($canEmployees && $employeesNavRoute)
                <a href="{{ $employeesNavRoute }}" @class(['sidebar-link', 'active'=> request()->routeIs('employees.*') || request()->routeIs('attendance.*') || request()->routeIs('salaries.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.employees') }}</span>
                </a>
                @endif

                @if ($canUsers)
                <a href="{{ route('printers.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('printers.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.printers') }}</span>
                </a>
                @endif

                @if ($canUsers)
                <a href="{{ route('users.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('users.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 18.75a3 3 0 0 0 3-3v-1.5a3 3 0 0 0-2.25-2.9M18 18.75H6m12 0v1.5m-12-1.5v1.5m0-1.5a3 3 0 0 1-3-3v-1.5a3 3 0 0 1 2.25-2.9m10.5-4.35a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 1.5a2.25 2.25 0 1 1 0-4.5 2.25 2.25 0 0 1 0 4.5Zm12 0a2.25 2.25 0 1 1 0-4.5 2.25 2.25 0 0 1 0 4.5Z" />
                    </svg>
                    <span class="sidebar-label">{{ __('ui.navigation.users') }}</span>
                </a>
                @endif

                @if ($canMarketing && $marketingNavRoute)
                <a href="{{ $marketingNavRoute }}" @class(['sidebar-link', 'active'=> request()->routeIs('offers.*') || request()->routeIs('coupons.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.offers') }}</span>
                </a>
                @endif

                @if ($canReports)
                <a href="{{ route('reports.shift-logs') }}" @class(['sidebar-link', 'active'=> request()->routeIs('reports.shift-logs*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.shift_logs') }}</span>
                </a>
                <a href="{{ route('financial.index') }}" @class(['sidebar-link', 'active'=> request()->routeIs('financial.*')])>
                    <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="sidebar-label">{{ __('ui.navigation.financial') }}</span>
                </a>
                @endif
            </div>
        </div>
